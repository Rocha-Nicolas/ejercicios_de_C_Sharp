...
namespace ejercicio2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese el importe total de la cantidad de litros vendidos: ");
            ...
            Console.WriteLine("El importe total por la venta segun los litros es " + importeTotal);
